    ...
    async login () {
      ...
      try {
        ...
        const user = {
          ...
          email: response.data.vendor_data.email,
          phone: response.data.vendor_data.phone,
          address: response.data.vendor_data.address,
          rating: response.data.vendor_data.rating,
          imageUrl: response.data.vendor_data.image_url,
          latitude: response.data.vendor_data.latitude,
          longitude: response.data.vendor_data.longitude
        }
