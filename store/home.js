export const state = () => ({
  ...
  itemsvertical: [
    ...
    { id: 3, name: 'Sandwich', discount: 0.75, originalPrice: 480, quantity: '500g', stockLeft: 10, expiredDate: '18/10/2023', src: 'sandwich' },
    { id: 4, name: 'Udon', discount: 0.75, originalPrice: 800, quantity: '700g', stockLeft: 6, expiredDate: '15/10/2023', src: 'udon' },
    { id: 5, name: 'Kurma Milk', discount: 0.5, originalPrice: 350, quantity: '1000ml', stockLeft: 10, expiredDate: '18/10/2023', src: 'kurmamilk' }
  ],
  foods: [
